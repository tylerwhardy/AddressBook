...
import static edu.citadel.tyler.addressbook.MainActivity.*;
...
public class EmergencyProvider extends ContentProvider
{
    ...
    MainActivity.EmergencyDbOpenHelper dbHandler = new MainActivity.EmergencyDbOpenHelper(getContext());
